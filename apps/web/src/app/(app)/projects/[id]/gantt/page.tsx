...
export default async function ProjectGanttPage({ params, searchParams }: { params: { id: string }; searchParams: { importPreview?: string; importStatus?: string } }) {
  ...
  return (
    <>
      <PageHeader title={`Planejamento & To-do | ${project.name}`} description="Cronograma, Gantt, importacao MPP, baselines e gestao operacional das tarefas em um unico fluxo." />
