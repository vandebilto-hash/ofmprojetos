      ...
      <div className="mb-4 flex justify-end">
        <DialogAction title="Cadastrar parte interessada" description="Adicione uma nova parte interessada ao mapa de governança." trigger="create" triggerLabel="Nova parte interessada">
          <form action={createStakeholderAction} className="grid gap-3">
            ...
            <label className="grid gap-1 text-sm font-medium">Classificação<input name="classification" placeholder="Gerenciar de perto, manter informado..." className="h-10 rounded-md border border-line px-3" /></label>
                ...
                <div className="flex gap-2">
                  <DialogAction title="Editar parte interessada" description={item.name} trigger="edit">
                    <form action={updateStakeholderAction} className="grid gap-3">
                      ...
                      <label className="grid gap-1 text-sm font-medium">Classificação<input name="classification" defaultValue={item.classification ?? ""} className="h-10 rounded-md border border-line px-3" /></label>
